...
class Camera:
    ...
    def get_adapted_intrinsic(self, desired_resolution):
        ...
        print(self.intrinsic_original_resolution, desired_resolution)
        if tuple(self.intrinsic_original_resolution) == tuple(desired_resolution):
