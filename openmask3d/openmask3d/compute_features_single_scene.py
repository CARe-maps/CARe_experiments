...
import sys
print(sys.path)
sys.path.append('/tmp2/htsu/mp3d_pointcloud_gen/openmask3d')
...
def main(ctx: DictConfig):
    ...
    # print(f"[INFO] Loading images with indices: {indices}")
    # print(f"[INFO] Loading images from {ctx.data.images.images_path} with extension {ctx.data.images.images_ext}.")
    # raise
