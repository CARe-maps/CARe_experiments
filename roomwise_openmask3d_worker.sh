...
# data paths
# SCENE_DIR="/tmp2/htsu/mp3d_pointcloud_gen/openmask3d/resources/mp3d_0323_25mm/2azQ1b91cZZ/2"
SCENE_DIR=$1
SCENE_POSE_DIR="${SCENE_DIR}/pose" #not processed yet
SCENE_INTRINSIC_PATH="${SCENE_DIR}/intrinsic/intrinsic_color.txt" #not processed yet
SCENE_INTRINSIC_RESOLUTION="[1024,1280]" #not processed yet# change if your intrinsics are based on another resolution
SCENE_PLY_PATH="${SCENE_DIR}/pointcloud.ply" #no SCENE_DIR, not processed yet, 
SCENE_COLOR_IMG_DIR="${SCENE_DIR}/color"
SCENE_DEPTH_IMG_DIR="${SCENE_DIR}/depth"
IMG_EXTENSION=".jpg"
DEPTH_EXTENSION=".png"
DEPTH_SCALE=4000 #not processed yet
# model ckpt paths
...
EXPERIMENT_NAME="experiment_mp3d_ext"
